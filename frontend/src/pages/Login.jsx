...
import { MessageSquare, Lock, Mail, Loader2, ArrowRight, Zap, Shield, Smartphone } from 'lucide-react';
      ...
      <div className="w-full max-w-5xl bg-white/80 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl shadow-2xl overflow-hidden relative z-10 animate-slideUp flex flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex w-1/2 p-12 flex-col justify-between relative bg-slate-50/50 dark:bg-black/20">
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">
              Sign in to access your conversations, connect with friends, and stay updated in real-time.
            </p>

            <div className="space-y-4">
              {[
                { icon: Zap, text: "Instant synchronization" },
                { icon: Shield, text: "Secure login & data protection" },
                { icon: Smartphone, text: "Seamless mobile experience" }
              ].map((item, i) => (
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12 bg-white/50 dark:bg-white/5">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">Sign in to continue to ChatApp</p>
          </div>

          {/* Form Content */}
          <form onSubmit={login} className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" class="text-xs text-emerald-500 dark:text-emerald-400 hover:text-emerald-600 dark:hover:text-emerald-300 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative group">
            ...
            <div className="flex items-center">
              <input
                id="remember-me"
                type="checkbox"
                className="h-4 w-4 rounded border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-black/20 text-emerald-500 focus:ring-emerald-500/50 focus:ring-offset-0"
              />
          ...
          {error && (
            <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl flex items-start gap-3 animate-shake">
          ...
          <div className="text-center mt-8 pt-6 border-t border-slate-200 dark:border-white/5">
            <p className="text-slate-500 dark:text-slate-400 text-sm">
              ...
              <Link to="/signup" className="text-emerald-500 dark:text-emerald-400 font-semibold hover:text-emerald-600 dark:hover:text-emerald-300 transition-colors">
                Register
              </Link>
            </p>
          </div>
